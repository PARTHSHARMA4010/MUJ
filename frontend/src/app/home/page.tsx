    ...
    <div className="min-h-screen text-white">
      ...
      >
        <div className="text-left text-gray-900">
          <h2 className="text-4xl font-bold mb-4">Advanced Disaster Response</h2>
          <p className="text-lg mb-6">
            Real-time aerial surveillance with AI-based debris detection <br />
            and high-definition monitoring for{" "}
            <b>
              earthquake damage assessment, <br /> structural analysis,
            </b>{" "}
            and <b>recovery planning</b>
          </p>
        ...
        <div className="ml-10">
          <Image
            src="/drone-monitoring.svg"
            alt="Drone Monitoring"
            width={500}
            height={300}
            className="rounded-lg shadow-lg border-2 border-amber-600 bg-gradient-to-br from-gray-50 to-amber-50 p-2"
          />
        </div>
      </section>
      ...
      <section
        id="crowd"
        className="flex items-center justify-center h-screen px-10 bg-gradient-to-r from-amber-50 to-gray-50 dark:from-gray-800 dark:to-gray-900"
      >
        <Image
          src="/crowd3.jpg"
          ...
          width={500}
          height={400}
          className="rounded-lg shadow-lg ml-10 border-2 border-amber-600"
        />
        <div className="text-left text-gray-900 ml-20">
          <h2 className="text-4xl font-bold mb-4 text-amber-800 dark:text-amber-500 drop-shadow-md">Debris Detection & Analysis</h2>
          <div className="relative inline-block bg-white/70 dark:bg-gray-800/70 p-4 rounded-lg shadow-md border-l-4 border-amber-600">
            <p className="text-lg mb-6">
              AI-powered analytics to identify and classify debris in disaster zones <br />
              and to assist in earthquake damage assessment and recovery efforts.
            </p>
            <button className="bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-6 rounded-lg mt-2 shadow-md">
               Analyze Debris
             </button>
          </div>
        </div>
